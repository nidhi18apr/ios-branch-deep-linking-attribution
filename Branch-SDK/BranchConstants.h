...
extern NSString * const BRANCH_URL_QUERY_PARAM_GBRAID;

extern NSString * const BRANCH_NATIVE_CAPPING_DECISION;
extern NSString * const BRANCH_NATIVE_COMPUTE;
extern NSString * const BRANCH_NATIVE_VERIFICATION_MODE;
